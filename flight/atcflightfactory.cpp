...
ATCFlight *ATCFlightFactory::newFlight(State s, ATC::FlightRules fr, QString adep, QString ades, QString altitude, QTime dep)
{
...
ATCFlight *ATCFlightFactory::newFlight(State s, ATC::FlightRules fr, QString adep, QString ades, QString altitude, QTime dep, QString sq)
{
    ATCFlightPlan* plan = flightPlanFactory.newFlightPlan(fr, adep, ades, altitude, dep);
