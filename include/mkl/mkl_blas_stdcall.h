...
float* __stdcall SGEMM_ALLOC(const char *identifier, int identifier_len, const MKL_INT *m, const MKL_INT *n, const MKL_INT *k);
...
void __stdcall SGEMM_FREE(float *mat); 
...
double* __stdcall DGEMM_ALLOC(const char *identifier, int identifier_len, const MKL_INT *m, const MKL_INT *n, const MKL_INT *k);
...
void __stdcall DGEMM_FREE(double *mat); 
